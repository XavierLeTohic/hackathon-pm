  ...
  render () {
    ...
    return (
    	<FlexContainerLayout nameClass="header-search">
    		...
    		<ImgBtnLayout id="btnBlock" name="Panier" icon="grid imgBtn-header"></ImgBtnLayout>
    		<ImgBtnLayout id="btnInline" name="Connexion" icon="list imgBtn-header"></ImgBtnLayout>
