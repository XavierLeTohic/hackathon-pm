...
class Tab extends React.Component {
		...
		getTemplate() {
			...
			return(
				<li className={this.props.className}><a id={this.props.id} href={this.props.url} className={this.props.className} data-modal={this.props.modalID}>{this.props.name}</a></li>
			)
		}
